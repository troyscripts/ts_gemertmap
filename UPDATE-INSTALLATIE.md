...
3. Laat je bestaande config.lua staan; het configschema blijft 1.0.6.
...
De kaart krijgt geen verplichte bridge-afhankelijkheid. ox_lib is wel vereist voor meldingen.
...
/postcode, /postcode [nummer] en /postcode uit zijn beschikbaar.

Nieuwe scriptversie: 1.0.7. Configschema: 1.0.6 (ongewijzigd).
...
gebiedsnamen, ongeldige coördinaten, behoud van 001, /postcode en GitHub-foutscenario's.
